...
<!-- Navbar -->
<nav class="navbar navbar-light bg-light site-header sticky-top py-1"><img src="imagens/logo.png"
                                                                           class="img-fluid rounded " id="logo"
    ...
    <div class="dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdown-educacional">
            ...
            <a class="dropdown-item" href="https://www.youtube.com/watch?v=aGGYFxLdFMw" target="_blank">Guia bem Básico
                para começar a Investir (Me poupe!)</a>
            <hr>

            <a class="dropdown-item" href="https://youtu.be/yHuNhkntc-I" target="_blank">Guia Básico para Investir (O
                Primo Rico)</a>
            <hr>

            <a class="dropdown-item" href="https://www.youtube.com/watch?v=dJyJ77GkhBE" target="_blank">Como começar a
                Investir (O Primo Rico)</a>
            <hr>

            <a class="dropdown-item" href="https://www.youtube.com/watch?v=PtAkxzMhobQ" target="_blank">Como começar a
                Investir (Jovens de Negócios)</a>
            <hr>

            <a class="dropdown-item" href="https://www.youtube.com/watch?v=-sGOvusS5NI" target="_blank">3 Investimentos
                para Iniciantes (O Primo Rico)</a>
    ...
    <div class="dropdown">
        ...
        <button class="btn btn-warning dropdown-toggle" type="button" id="dropdown-plataformas" data-toggle="dropdown"
                aria-haspopup="true" aria-expanded="false"
                style="margin-right:5px; background-color: #fa2b40; margin-right:5px;">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdown-plataformas">
            ...
            <a class="dropdown-item"
               href="https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source=web&cd=&cad=rja&uact=8&ved=2ahUKEwjpqZmKzq_xAhXVqZUCHe7ECV8QFjAAegQICRAD&url=https%3A%2F%2Fwww.xpi.com.br%2F&usg=AOvVaw37hN5c1rO_oWzVFb3GFE-t"
               target="_blank"><img src="imagens/xp.jpg"></a>
            <!--https://logospng.org/download/xp-investimentos/logo-xp-investimentos-2048.png-->

            <hr>

            <a class="dropdown-item"
               href="https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source=web&cd=&cad=rja&uact=8&ved=2ahUKEwjvob6bzq_xAhXyr5UCHW_pCk4QFjAAegQIBhAD&url=https%3A%2F%2Fcorretora.clear.com.br%2F&usg=AOvVaw0lz1qnpBwG7FQ3J3-ItywV"
               target="_blank"><img src="imagens/clear.jpg"></a>
            ...
            <a class="dropdown-item" href="https://www.easynvest.com.br" target="_blank"><img
                        src="imagens/easynvest.jpg"></a>
...
<section>
    <div class="container col-md-3" id="container-form-gestao" style="background-color: #dad4ce98;">
        ...
        <center>
            <form method="post" method="get" action="GestaoPessoal.php">
...
<!-- <button type="button" v-bind:onclick="calcular " class="btn btn-secondary" style="margin-bottom: 10px;"> -->
                ...
                <div class="form-group col-md-10">
                    ...
                    <input type="text" name="email" class="form-control" id="inputemail"
                           placeholder="Informe aqui seu E-mail!" required="">
                ...
                <button type="submit" class="btn btn-primary btn btn-warning"
                        style="background-color: #ffad15; color: #f1eeee; margin-bottom: 10px;">Gerar Relatório
                </button>

                <button type="submit" class="btn btn-primary btn btn-danger"
                        style="background-color: #fa2b40; margin-bottom: 10px;">Finalizar
                </button>
